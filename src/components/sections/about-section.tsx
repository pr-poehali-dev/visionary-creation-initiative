        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                We are a team of designers, developers and technologists who create exceptional digital products.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Every project is an opportunity to explore new solutions and push the boundaries of what's possible.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              ...
              { value: "8", label: "Years", sublabel: "Of experience & innovation", direction: "left" },
